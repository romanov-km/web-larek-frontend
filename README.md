...
Приведенный код представляет собой реализацию приложения интернет-магазина. В рамках парадигмы проектирования MVC (Model-View-Controller), выделение слоев представлено ниже:
